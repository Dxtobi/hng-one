const colors = [
 '#40E0D0', '#800000', '#008080', '#EE82EE', '#F5F5DC', '#F5DEB3', '#F4A460', '#F0E68C', '#EEE8AA', '#E9967A', '#E6E6FA', '#E0FFFF', '#DEB887', '#DDA0DD', '#DCDCDC', '#DC143C', '#DB7093', '#DAA520', '#DA70D6', '#D8BFD8', '#D3D3D3', '#D2B48C', '#D2691E', '#CD853F', '#CD5C5C', '#C71585', '#C0C0C0', '#B22222', '#B0E0E6', '#B0C4DE', '#B0B0B0'
  ...
  '#808080', '#A52A2A', '#FFC0CB', '#FFD700', '#FF0000', '#00FF00', '#0000FF', '#FFFF00', '#FF00FF', '#4B0082', '#FF4500', '#FF1493', '#FF69B4', '#FF6347', '#FF7F50', '#FF8C00', '#FFA07A', '#FFB6C1', '#FFDAB9', '#FFDEAD', '#FFE4B5', '#FFE4C4', '#FFE4E1', '#FFEBCD', '#FFEFD5', '#FFFAF0', '#FFFAFA', '#FFFFE0', '#FFFFF0', '#FFFFF0', '#FFFFFF'
